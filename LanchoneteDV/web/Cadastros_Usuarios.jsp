<%-- 
    Document   : Cadastros_Usuarios
    Created on : 10/10/2016, 15:59:37
...
<html>
   ...
   <body background= "fundo" align="center" style="background-repeat: no-repeat; background-size:  100%; background-position-x: center">
	...
	<div class="panel-heading">
        <form class="form-horizontal" class="form-horizontal" action="UsuarioServlet" method="post">
          <div class="form-group">   
            ...
            <label>Nome:</label>
            <input name="nome_sobrenome" placeholder="Nome e Sobrenome">
            <br>
            <br>
